...
1. Explain the S&R or S&D context: {zone_note if zone_note else ‘describe the key price levels at play’}.
1. Summarise the momentum confirmation from RSI={d[‘rsi’]:.1f}, EMA alignment, and MACD.
